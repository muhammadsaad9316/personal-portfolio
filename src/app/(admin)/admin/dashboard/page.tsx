...
export default async function AdminDashboard() {
    try {
        ...
        return (
            <div style={{ padding: '2rem', maxWidth: '800px', margin: '4rem auto', textAlign: 'center' }}>
                <div style={{
                    background: 'white',
                    padding: '3rem 2rem',
                    borderRadius: '12px',
                    ...
                    <p style={{ color: '#6b7280', marginBottom: '2rem', lineHeight: '1.6' }}>
                        We couldn't connect to the database. This might be a temporary issue.
                        <br />Please check your database connection and try again.
                    </p>
                    <Link
